    ...
    $.ajax({
        ...
        success: function(resp) {
            ...
            if (resp.length > 0) {
                ...
                cadena_comisaria += "<center><button class='btn btn-info' style='padding:0.5px 3px 0.5px 3px'><i class='fa fa-download'></i> <a href='../../controlador/institucion/" + data[11] + "' download='Acta_denuncia'>Copia Simple Acta de Denuncia <br>Verbal / Intervención Policial</a> </button></center>";
                ...
                cadena_juzgado += "<center><button class='btn btn-info' style='padding:0.5px 3px 0.5px 3px'><i class='fa fa-download'></i> <a href='../../controlador/institucion/" + data[12] + "' download='Demanda_electronica'>Copia de Demanda Electrónica</a> </button></center>";
                ...
                cadena_pericias += "<center><h5 ><i class='fa fa-download'></i><u><a style='color:blue' href='../../controlador/institucion/" + data[18] + "' download='Informe_psicologico_CEM'>Informe Psicológico de CEM </a></u></h5></center>";
                cadena_pericias += "<h5><b>N° de Informe Psicológico de CEM: </b> " + data[17] + "</h5><hr>";
                cadena_pericias += "<center><h5><i class='fa fa-download'></i><u><a style='color:blue' href='../../controlador/institucion/" + data[20] + "' download='Informe_psicologico_SAU'>Informe Psicológico de SAU: </a></u></h5></center>";
                cadena_pericias += "<h5><b>N° de Informe Psicológico de SAU: </b> " + data[19] + "</h5><hr>";
                cadena_pericias += "<center><h5><i class='fa fa-download'></i><u><a style='color:blue' href='../../controlador/institucion/" + data[22] + "' download='Informe_Social_CEM'>Informe Social de CEM: </a></u></h5></center>";
                cadena_pericias += "<h5><b>N° de Informe Social de CEM: </b> " + data[21] + "</h5>";
                $("#listar_pericias").html(cadena_pericias);

                cadena_medidas += "<center><h5><i class='fa fa-download'></i><u><a style='color:blue' data-lang='medidasp'href='../../controlador/institucion/" + data[22] + "' download='Medidas_proteccion'>Medidas de protección  </a></u></h5><center>"
